...
%Inputs 
%N: Number of timesteps (4/year)
%Kv: Vertical Diffusion coefficient (nominal 1e-5 m^2/s)
%AI: Gent-McWilliams Diffusion coefficient (nominal 1000 m^2/s)
%Mek: Southern Ocean Ekman flux (nominal 25e6)
%Aredi: Lateral mixing coefficient (nominal 1000 m^2/s)
%M_s: Southern Mixing flux (nominally AABW formation, 15e6 m^3/s)
%epsilon: Frictional resistance to flow, nominal value 1.2e-4;
